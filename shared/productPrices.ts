...
export const PRODUCT_PRICES: Record<string, { name: string; priceNum: number }> = {
  ...
  'sp-alarm-keyless': { name: 'Alarm Keyless VOXA', priceNum: 0 },
  'sp-as-roda-depan': { name: 'As Roda Depan VOXA', priceNum: 0 },
  'sp-charger': { name: 'Charger Sepeda Listrik VOXA', priceNum: 0 },
  'sp-charger-grade-a': { name: 'Charger Grade A VOXA', priceNum: 0 },
  'sp-controller-350w': { name: 'Controller 350W VOXA', priceNum: 0 },
  'sp-controller-500w': { name: 'Controller 500W VOXA', priceNum: 0 },
  'sp-fork-garpu-depan': { name: 'Fork Garpu Depan VOXA', priceNum: 0 },
  'sp-jok-belakang': { name: 'Jok Belakang VOXA', priceNum: 0 },
  'sp-jok-depan': { name: 'Jok Depan VOXA', priceNum: 0 },
  'sp-kabel-motor-350w': { name: 'Kabel Motor 350W VOXA', priceNum: 0 },
  'sp-kabel-motor-500w': { name: 'Kabel Motor 500W VOXA', priceNum: 0 },
  'sp-keranjang': { name: 'Keranjang VOXA', priceNum: 0 },
  'sp-klakson': { name: 'Klakson Trumpet Horn VOXA', priceNum: 0 },
  'sp-kunci-kontak': { name: 'Kunci Kontak VOXA', priceNum: 0 },
  'sp-lampu-depan': { name: 'Lampu Depan VOXA', priceNum: 0 },
  'sp-lampu-sein-depan': { name: 'Lampu Sein Depan VOXA', priceNum: 0 },
  'sp-motor-350w': { name: 'Motor Listrik 350W VOXA', priceNum: 0 },
  'sp-motor-500w': { name: 'Motor Listrik 500W VOXA', priceNum: 0 },
  'sp-pedal-set': { name: 'Pedal Set VOXA', priceNum: 0 },
  'sp-pijakan-kaki-depan': { name: 'Pijakan Kaki Depan VOXA', priceNum: 0 },
  'sp-rem-tromol-belakang': { name: 'Rem Tromol Belakang VOXA', priceNum: 0 },
  'sp-rem-tromol-depan': { name: 'Rem Tromol Depan VOXA', priceNum: 0 },
  'sp-set-grip': { name: 'Set Grip VOXA', priceNum: 0 },
  'sp-set-kabel-utama': { name: 'Set Kabel Utama VOXA', priceNum: 0 },
  'sp-set-tuas-rem': { name: 'Set Tuas Rem VOXA', priceNum: 0 },
  'sp-setang': { name: 'Setang VOXA', priceNum: 0 },
  'sp-shockbreaker': { name: 'Shockbreaker Set VOXA', priceNum: 0 },
  'sp-speedometer': { name: 'Speedometer VOXA', priceNum: 0 },
  'sp-spion': { name: 'Spion VOXA', priceNum: 0 },
  'sp-standar-samping': { name: 'Standar Samping VOXA', priceNum: 0 },
  'sp-standar-tengah': { name: 'Standar Tengah (Double Stand) VOXA', priceNum: 0 },
};
