...
const produkKamiCategories: Category[] = [
  {
    ...
    href: '/sepeda-listrik',
    subItems: [
      { name: 'Elite Fantasi', href: '/sepeda-listrik/elite-series/elite-fantasy' },
      { name: 'Elite Rider', href: '/sepeda-listrik/elite-series/elite-rider' },
      { name: 'Elite Fantasi S', href: '/sepeda-listrik/elite-series/elite-fantasy-s' },
      { name: 'Elite Rider S', href: '/sepeda-listrik/elite-series/elite-rider-s' },
      { name: 'Eiffel Rider', href: '/sepeda-listrik/eiffel-series/eiffel-rider' },
      { name: 'Eiffel City', href: '/sepeda-listrik/eiffel-series/eiffel-city' },
      { name: 'Eiffel 7', href: '/sepeda-listrik/eiffel-series/eiffel-7' },
      { name: 'Liberty', href: '/sepeda-listrik/liberty-series/liberty' },
      { name: 'Liberty Star', href: '/sepeda-listrik/liberty-series/liberty-star' },
      { name: 'Liberty Ultimate', href: '/sepeda-listrik/liberty-series/liberty-ultimate' },
      { name: 'Liberty Stylish', href: '/sepeda-listrik/liberty-series/liberty-stylish' },
      { name: 'Liberty 7', href: '/sepeda-listrik/liberty-series/liberty-7' },
      { name: 'Voxa G3', href: '/sepeda-listrik/voxa-series/voxa-g3' },
      { name: 'Voxa Kurir', href: '/sepeda-listrik/voxa-series/voxa-kurir' },
    ],
  },
  {
    name: 'Baterai',
  ...
  },
  {
    ...
    href: '/sparepart',
    subItems: [
      { name: 'Motor Listrik', href: '/sparepart/motor-listrik' },
      { name: 'Controller', href: '/sparepart/controller' },
      { name: 'Charger', href: '/sparepart/charger' },
      { name: 'Rem & Komponen', href: '/sparepart/rem-dan-komponen' },
      { name: 'Ban & Velg', href: '/sparepart/ban-dan-velg' },
    ],
  },
];
                  ...
                  {isAuthenticated && user ? (
                    <>
                      ...
                      <div className="py-1">
                        ...
                        {user.role === 'admin' && (
                          <Link href="/admin/seo" className="flex items-center gap-2.5 px-4 py-2.5 text-sm font-semibold hover:bg-[#37C5FF]/10 transition-colors" style={{ color: '#37C5FF' }}>
                            <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <circle cx="11" cy="11" r="8" strokeWidth={2}/><line x1="21" y1="21" x2="16.65" y2="16.65" strokeWidth={2}/>
                            </svg>
                            <span className="whitespace-nowrap">SEO / GEO Optimizer</span>
                          </Link>
                        )}
                        <button
                          onClick={() => logout()}
              ...
              <div className="pt-3 border-t border-gray-100 space-y-1">
                {isAuthenticated && user ? (
                  <>
                    ...
                    {user.role === 'admin' && (
                      <Link href="/admin/ads" className="flex items-center gap-2 px-3 py-2.5 text-sm font-semibold rounded hover:bg-[#37C5FF]/10 transition-colors" style={{ color: '#37C5FF' }}>
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3v18h18M7 14l4-4 4 4 5-5" />
                        </svg>
